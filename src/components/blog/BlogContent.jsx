...
export default function BlogContent() {
  ...
  const layout = searchParams.get("layout") || "left";
  const hasSidebar = layout !== "full";
  const sidebarPosition = layout;

  const sidebar = (
    <div
      className="sp-blogs-sidebar sp-blogs-leftside col-lg-4 order-lg-first col-md-12 order-md-last m-t-991 aos-init"
      data-aos="fade-up"
          ...
          <div className="row">
            ...
            >
              <div className="sp-blogs-content">
                <div
                  className="sp-blogs-inner aos-init"
                  data-aos="fade-up"
                  data-aos-duration="1000"
                  data-aos-delay="200"
                >
                  <div className="row">
                    {blogPosts.map((post) => (
                      <div
                        className="col-xxl-4 col-xl-6 col-md-6 m-b-30"
                        key={post.id}
                      >
                  ...
                  <ul className="sp-pro-pagination-inner">
                    ...
                    <li>
                      <a className="next" href="#!">
                        Next <i className="gicon sp-angle-right"></i>
                      </a>
                    </li>
                  </ul>
                </div>
