...
export default function MobileMenu({ isOpen, onClose }) {
    ...
    return (
        <>
            <div className="sp-mobile-menu-overlay" style={{ display: isOpen ? "block" : "none" }} data-cursor="hide" onClick={onClose}></div>
            <div id="sp-mobile-menu" className={`sp-mobile-menu ${isOpen ? "sp-menu-open" : ""}`}>
                <div className="sp-menu-title">
                    <span className="menu_title">My Menu</span>
                    <button type="button" className="sp-close-menu" onClick={onClose}>×</button>
                </div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul className="sub-menu" style={{ display: openMenus.blog ? "block" : "none" }}>
                                    ...
                                    <li><Link href="/blog?layout=full">Full Width</Link></li>
                                    <li><Link href="/blog/1?layout=left">Detail Left Sidebar</Link></li>
                                    <li><Link href="/blog/1?layout=right">Detail Right Sidebar</Link></li>
                                    <li><Link href="/blog/1?layout=full">Detail Full Width</Link></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
